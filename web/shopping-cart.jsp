                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <form action="MainController" method="POST">
                                                                                    <div class="row w-75">
                                                                                        <div class="col-8">
                                                                                            <input class="form-control" value="${product.quantity}" type="number" min="1" step="1" placeholder="quantity" name="txtQuantity" required="">
                                                                                        </div>
                                                                                        <div class="col-4">
                                                                            ...
                                                                            <td>
                                                                                <fmt:setLocale value = "vi_VN"/>
                                                                                <fmt:formatNumber value = "${product.salePrice*product.quantity}" type = "currency"/>
                                                                            </td>
                                                ...
                                                <div class="col">
                                                    <div>
                                                        <form action="MainController" method="POST">
                                                            ...
                                                            <input class="btn w-75 btn-lg btn-outline-secondary" name="btnAction" type="submit" value="Check Out Your Cart">
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
