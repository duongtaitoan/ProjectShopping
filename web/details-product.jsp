                                            ...
                                            <div class="row w-100">
                                                ...
                                                <div class="col-7">
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <c:if test="${not empty LIST_SIZE}">
                                                            <select name="selectSize" class="form-control">
                                                                <option value="0">SELECT SIZE</option>
                                                                <c:forEach items="${LIST_SIZE}" var="size">
                                                                    <option class="dropdown-item" 
                                                                            value="${size.sizeId}" ${size.getSizeId() == searchedSize ? 'selected' : ''}>${size.sizeProduct}</option>
                                                                </c:forEach>
                                                            </select>
                                                        </c:if>
                                                    </div>
