                ...
                <div class="container-fluid">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-3 mt-2">
                                                            <div class="form-group">
                                                                <label></label>
                                                                <div class="w-100">
                                                                    <button style="padding: 9px" class="btn w-100 btn btn-outline-dark" name="btnAction" value="Search History Product">Search</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <c:if test="${LIST_ORDER != null}">
                                    ...
                                    <div class="active-member">
                                        <div class="table-responsive shadow-lg p-3 bg-body rounded">
                                            <c:forEach items="${LIST_ORDER}" varStatus="count" var="order" >
                                                <div class="wrapper mt-3 mb-1">
                                                    <div class="wrapper-header">
                                                        <p>${count.count}.Date Order :<strong>${order.orderDate}</strong></p>
                                                    </div>
                                                    <div class="row container">
                                                        <div class="wrapper-content">
                                                            <c:forEach items="${order.orderDetails}" var="orderDetail" varStatus="count">
                                                                <div class="card-body border border-1 p2 mb-3">
                                                                    <div class="row">
                                                                        <div class="col-2">
                                                                            STT:${count.count}
                                                                        </div>
                                                                        <div class="col-4">
                                                                            <p> Product Id: ${orderDetail.productId}</p>
                                                                            <p> Name Product: ${orderDetail.productName}</p>
                                                                            <p> Quantity: ${orderDetail.quantity}</p>
                                                                        </div>
                                                                        <div class="col-4 position-relative">
                                                                            <span class="position-absolute bottom-0 end-0"> Price:
                                                                                <fmt:setLocale value = "vi_VN"/>
                                                                                <fmt:formatNumber value = "${orderDetail.unitPrice}" type = "currency"/>
                                                                                <c:set var="totalPrice" value="${totalPrice+(orderDetail.unitPrice)}"/>
                                                                            </span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                        ...
                        <c:if test="${empty LIST_ORDER}">
                            <h3 class="text-center" style="color: black">Not found order product <i class="fa-solid fa-face-frown-open"></i></h3>
                            </c:if>
                        </c:if>
