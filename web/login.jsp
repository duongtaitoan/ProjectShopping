                    ...
                    <div style="padding: 0 20%; margin-top: 10px ">
                        <c:if test="${not empty LOGIN_MSG}">
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                <strong>Note:</strong> <span font-weight-semi-bold text-capitalize style="color: black">${LOGIN_MSG}</span>
                            ...
                            <div class="card-body">
                                <form action="MainController" method="POST">
                                    <div class="form-group mt-2">
                                        ...
                                        <label>Email</label>
                                        <input type="text" class="form-control mt-2" maxlength="50" name="txtEmail" placeholder="teo@gmail.com" required="">
                                    </div>
                                    <div class="form-group mt-2">
                                        <i class="fa-solid fa-key"></i>
                                        <label>Password</label>
                                        <input type="password" class="form-control mt-2" maxlength="50" name="txtPassword" placeholder="*****" required="">
                                    </div>
                                    <div class="row mt-4">
                                        <div class="col">
